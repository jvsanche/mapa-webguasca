...
function exp_vias_5rule0_eval_expression(context) {
    // 
...
function exp_vias_5rule1_eval_expression(context) {
    // TIPO_VIA = 1
...
function exp_vias_5rule2_eval_expression(context) {
    // TIPO_VIA = 5
...
function exp_vias_5rule3_eval_expression(context) {
    // TIPO_VIA = 6
...
function exp_vias_5rule4_eval_expression(context) {
    // TIPO_VIA = 7
...
function exp_vias_5rule5_eval_expression(context) {
    // TIPO_VIA = 2
...
function exp_vias_5rule6_eval_expression(context) {
    // TIPO_VIA = 3
...
function exp_vias_5rule7_eval_expression(context) {
    // TIPO_VIA = 4
